...
public class PostgreSQLBackendImplTest {
    ...
    // mocks
    @Mock
    private PostgreSQLDriver mockDriverDbCreate;
    @Mock
    ...
    private final String schemaName1 = "schema1";
    private final String schemaName2 = "schema2";
    ...
    public void setUp() throws Exception {
        ...
        backend = new PostgreSQLBackendImpl(host, port, user, password);
    ...
    /**
     * Test of createDatabase method, of class PostgreSQLBackendImpl.
     */
    @Test
    public void testCreateDatabase() {
        System.out.println("Testing PostgreSQLBackend.createDatabase (first database creation");
        ...
        System.out.println("Testing PostgreSQLBackend.createDatabase (second database creation");
    ...
    public void testCreateTable() {
        ...
        try {
            ...
            backend.createDatabase(dbName1);
            backend.createSchema(dbName1, schemaName1);
            backend.createTable(dbName1, schemaName1, tableName1, fieldNames1);
        } catch (Exception e) {
            fail(e.getMessage());
        } finally {
            assertTrue(backend.getDriver().isConnectionCreated(""));
        ...
        try {
            backend.createDatabase(dbName2);
            backend.createSchema(dbName2, schemaName2);
            backend.createTable(dbName2, schemaName2, tableName2, fieldNames2);
        } catch (Exception e) {
            fail(e.getMessage());
        } finally {
            assertTrue(backend.getDriver().isConnectionCreated(""));
